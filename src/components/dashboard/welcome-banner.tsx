...
export function WelcomeBanner() {
  return (
    <Card className="overflow-hidden bg-gradient-to-r from-blue-900 to-indigo-900 text-primary-foreground shadow-lg">
      <CardContent className="p-0">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="relative md:w-1/2 h-48 md:h-auto opacity-20 md:opacity-100">
             <Image
